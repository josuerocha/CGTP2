...
caixadeareia::caixadeareia()
{
}

caixadeareia::caixadeareia(GLuint* topoTextura, GLuint* baseTextura)
{
...
void caixadeareia::lerArquivo(const char *path) {
