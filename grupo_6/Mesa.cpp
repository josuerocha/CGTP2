...
void Mesa::Display() {
	...
	glVertex3f(temp_v1[0].x, temp_v1[0].y, temp_v1[0].z);
	glVertex3f(temp_v1[1].x, temp_v1[1].y, temp_v1[1].z);
	glVertex3f(temp_v1[2].x, temp_v1[2].y, temp_v1[2].z);
	glVertex3f(temp_v1[3].x, temp_v1[3].y, temp_v1[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[1].x, normais[1].y, normais[1].z);
	glVertex3f(temp_v2[0].x, temp_v2[0].y, temp_v2[0].z);
	glVertex3f(temp_v2[1].x, temp_v2[1].y, temp_v2[1].z);
	glVertex3f(temp_v2[2].x, temp_v2[2].y, temp_v2[2].z);
	glVertex3f(temp_v2[3].x, temp_v2[3].y, temp_v2[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[2].x, normais[2].y, normais[2].z);
	glVertex3f(temp_v3[0].x, temp_v3[0].y, temp_v3[0].z);
	glVertex3f(temp_v3[1].x, temp_v3[1].y, temp_v3[1].z);
	glVertex3f(temp_v3[2].x, temp_v3[2].y, temp_v3[2].z);
	glVertex3f(temp_v3[3].x, temp_v3[3].y, temp_v3[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[3].x, normais[3].y, normais[3].z);
	glVertex3f(temp_v4[0].x, temp_v4[0].y, temp_v4[0].z);
	glVertex3f(temp_v4[1].x, temp_v4[1].y, temp_v4[1].z);
	glVertex3f(temp_v4[2].x, temp_v4[2].y, temp_v4[2].z);
	glVertex3f(temp_v4[3].x, temp_v4[3].y, temp_v4[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[4].x, normais[4].y, normais[4].z);
	glVertex3f(temp_v5[0].x, temp_v5[0].y, temp_v5[0].z);
	glVertex3f(temp_v5[1].x, temp_v5[1].y, temp_v5[1].z);
	glVertex3f(temp_v5[2].x, temp_v5[2].y, temp_v5[2].z);
	glVertex3f(temp_v5[3].x, temp_v5[3].y, temp_v5[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[5].x, normais[5].y, normais[5].z);
	glVertex3f(temp_v6[0].x, temp_v6[0].y, temp_v6[0].z);
	glVertex3f(temp_v6[1].x, temp_v6[1].y, temp_v6[1].z);
	glVertex3f(temp_v6[2].x, temp_v6[2].y, temp_v6[2].z);
	glVertex3f(temp_v6[3].x, temp_v6[3].y, temp_v6[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[6].x, normais[6].y, normais[6].z);
	glVertex3f(temp_v7[0].x, temp_v7[0].y, temp_v7[0].z);
	glVertex3f(temp_v7[1].x, temp_v7[1].y, temp_v7[1].z);
	glVertex3f(temp_v7[2].x, temp_v7[2].y, temp_v7[2].z);
	glVertex3f(temp_v7[3].x, temp_v7[3].y, temp_v7[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[7].x, normais[7].y, normais[7].z);
	glVertex3f(temp_v8[0].x, temp_v8[0].y, temp_v8[0].z);
	glVertex3f(temp_v8[1].x, temp_v8[1].y, temp_v8[1].z);
	glVertex3f(temp_v8[2].x, temp_v8[2].y, temp_v8[2].z);
	glVertex3f(temp_v8[3].x, temp_v8[3].y, temp_v8[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[8].x, normais[8].y, normais[8].z);
	glVertex3f(temp_v9[0].x, temp_v9[0].y, temp_v9[0].z);
	glVertex3f(temp_v9[1].x, temp_v9[1].y, temp_v9[1].z);
	glVertex3f(temp_v9[2].x, temp_v9[2].y, temp_v9[2].z);
	glVertex3f(temp_v9[3].x, temp_v9[3].y, temp_v9[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[9].x, normais[9].y, normais[9].z);
	glVertex3f(temp_v10[0].x, temp_v10[0].y, temp_v10[0].z);
	glVertex3f(temp_v10[1].x, temp_v10[1].y, temp_v10[1].z);
	glVertex3f(temp_v10[2].x, temp_v10[2].y , temp_v10[2].z);
	glVertex3f(temp_v10[3].x, temp_v10[3].y, temp_v10[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[10].x, normais[10].y, normais[10].z);
	glVertex3f(temp_v11[0].x, temp_v11[0].y, temp_v11[0].z);
	glVertex3f(temp_v11[1].x, temp_v11[1].y, temp_v11[1].z);
	glVertex3f(temp_v11[2].x, temp_v11[2].y, temp_v11[2].z);
	glVertex3f(temp_v11[3].x, temp_v11[3].y, temp_v11[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[11].x, normais[11].y, normais[11].z);
	glVertex3f(temp_v12[0].x, temp_v12[0].y, temp_v12[0].z);
	glVertex3f(temp_v12[1].x, temp_v12[1].y, temp_v12[1].z);
	glVertex3f(temp_v12[2].x, temp_v12[2].y, temp_v12[2].z);
	glVertex3f(temp_v12[3].x, temp_v12[3].y, temp_v12[3].z);
	glEnd();

	glBegin(GL_QUADS);
	glNormal3f(normais[12].x, normais[12].y, normais[12].z);
	glVertex3f(temp_v13[0].x, temp_v13[0].y, temp_v13[0].z);
	glVertex3f(temp_v13[1].x, temp_v13[1].y, temp_v13[1].z);
	glVertex3f(temp_v13[2].x, temp_v13[2].y, temp_v13[2].z);
	glVertex3f(temp_v13[3].x, temp_v13[3].y, temp_v13[3].z);
	glEnd();
